...
<body>
    ...
    <div class="row container">
        <div class="row">
            <form class="col s12" method="post" action="../php/devolver.php">
              <div class="row">
                <div class="input-field col l12">
                  <i class="material-icons prefix">account_circle</i>
                  <input name="id-emprestimo" id="tes" type="text" maxlength="30">
                  <label for="tes">ID DO EMPRÉSTIMO</label>
                </div>
              </div>                         
              <div class="row">
                <div class="input-field col s12">
                  <button class="btn waves-effect waves-light z-depth-2 btn-large" type="submit" name="emprestar">DEVOLVER<i class="material-icons right">add_circle_outline</i>
                  </button>
                </div>
              </div>      
            </form>
