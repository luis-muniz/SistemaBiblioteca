...
<body>
    ...
    <div class="row container">
        <div class="row">
            <form class="col s12" method="post" action="../php/cadastrar_usuario.php">
              <div class="row">
                <div class="input-field col l12">
                  <i class="material-icons prefix">account_circle</i>
                  <input name="nome" id="first_name" type="text" class="validate" maxlength="30">
              ...
              <div class="row">
                <div class="input-field col s12">
                  ...
                  <input name="senha" id="password" type="password" class="validate" maxlength="6">
              ...
              <div class="row">
                <div class="input-field col s12">
                  <button class="btn waves-effect waves-light z-depth-2 btn-large" type="submit" name="cadastrar">Cadastrar Usuário<i class="material-icons right">add_circle_outline</i>
                  </button>
                </div>
              </div>      
            </form>
